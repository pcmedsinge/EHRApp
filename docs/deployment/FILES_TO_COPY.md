...
|------|---------|------------|
| `docker-compose.full.yml` | Defines all services | Docker reads this to create containers |
...
- [ ] Check services: `docker-compose -f docker-compose.full.yml ps`
...
- ✅ Docker configs (docker-compose.full.yml, Dockerfiles)
