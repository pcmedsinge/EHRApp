 ...
 * Patient Create Page
 * 
 * Form for registering a new patient with validation.
 */

import { Form, Input, Button, Card, Row, Col, Select, DatePicker, Space, Divider } from 'antd';
import {
  UserAddOutlined,
  ArrowLeftOutlined,
  SaveOutlined,
...
import type { PatientCreateData, Gender, BloodGroup } from '@/types';
...
const PatientCreate = () => {
  ...
  return (
    <Card
      title={
        <Space>
          <UserAddOutlined style={{ color: colors.primary.main }} />
